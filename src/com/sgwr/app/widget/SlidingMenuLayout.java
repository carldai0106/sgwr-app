 ...
 * @author guolin
 */
public class SlidingMenuLayout extends RelativeLayout implements
		OnTouchListener {
	...
	{
		DisabledLeft, DisabledRight, DisabledLeftAndRight, DisabledNone
	}

	private DisabledType DisabledFlag = DisabledType.DisabledNone;
	...
	public void setDisabledType(DisabledType type)
	{
		DisabledFlag = type;
	}
	...
	{
		if (DisabledFlag == DisabledType.DisabledLeft
				|| DisabledFlag == DisabledType.DisabledLeftAndRight)
		{
			return;
		}
		else
	...
	{
		if (DisabledFlag == DisabledType.DisabledRight
				|| DisabledFlag == DisabledType.DisabledLeftAndRight)
		{
			return;
		}
